...
.field private static final VIDEO_HEIGHT:I = 0x438

.field private static final VIDEO_WIDTH:I = 0x780
...
.method private abandomAudioFocus()V
    .locals 1
...
.method public initPreview(IIILcom/android/camera/CameraScreenNail;)V
    ...
    iget-object p4, p0, Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;->mRecorder:Lcom/android/camera/module/impl/component/ILive$ILiveRecorder;

    if-nez p4, :cond_0

    new-instance p4, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;
    ...
    invoke-direct {p4, v0, v1, v2}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;-><init>(Lcom/android/camera/ActivityBase;II)V

    invoke-virtual {p4, p0}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;->setStateListener(Lcom/android/camera/module/impl/component/ILive$ILiveRecorderStateListener;)Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;

    move-result-object p4

    iget-object v0, p0, Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;->mUIHandler:Landroid/os/Handler;

    invoke-virtual {p4, v0}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;->setHandler(Landroid/os/Handler;)Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;

    move-result-object p4

    iget-object v0, p0, Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;->mRecordingTimeListener:Lcom/android/camera/module/impl/component/ILive$ILiveRecordingTimeListener;

    invoke-virtual {p4, v0}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;->setRecordingTimeListener(Lcom/android/camera/module/impl/component/ILive$ILiveRecordingTimeListener;)Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;

    move-result-object p4

    const-wide/16 v0, 0x3c28

    invoke-virtual {p4, v0, v1}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;->setMaxDuration(J)Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;

    move-result-object p4

    const/high16 v0, 0x1e00000

    invoke-virtual {p4, v0}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;->setBitrate(I)Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;

    move-result-object p4

    const/16 v0, 0x1e

    invoke-virtual {p4, v0}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;->setFps(I)Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;

    move-result-object p4

    sget-object v0, Lcom/android/camera/module/impl/component/FileUtils;->VIDEO_TMP:Ljava/lang/String;

    invoke-virtual {p4, v0}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;->setVideoSaveDirPath(Ljava/lang/String;)Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;
    ...
    invoke-virtual {p4, v0}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;->setSegmentData(Ljava/util/List;)Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;

    move-result-object p4

    invoke-virtual {p4}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;->build()Lcom/android/camera/module/impl/component/MiLiveRecorder;

    move-result-object p4

    iput-object p4, p0, Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;->mRender:Lcom/android/camera/SurfaceTextureScreenNail$SurfaceTextureScreenNailCallback;

    iput-object p4, p0, Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;->mRecorder:Lcom/android/camera/module/impl/component/ILive$ILiveRecorder;
    ...
    :goto_0
    invoke-interface {p4, p1, p2, p3}, Lcom/android/camera/module/impl/component/ILive$ILiveRecorder;->initPreview(IIZ)V
    ...
    :goto_1
    invoke-virtual {p0, v1, p1}, Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;->setFilter(ZLjava/lang/String;)V
...
.method public initResource()V
    ...
    sget-object p0, Lcom/android/camera/module/impl/component/FileUtils;->ROOT_DIR:Ljava/lang/String;

    invoke-static {p0}, Lcom/android/camera/module/impl/component/FileUtils;->hasDir(Ljava/lang/String;)Z

    move-result p0

    if-eqz p0, :cond_0

    sget-object p0, Lcom/android/camera/module/impl/component/FileUtils;->RESOURCE_DIR:Ljava/lang/String;
    ...
    sget-object p0, Lcom/android/camera/module/impl/component/FileUtils;->VIDEO_TMP:Ljava/lang/String;

    invoke-static {p0}, Lcom/android/camera/module/impl/component/FileUtils;->makeNoMediaDir(Ljava/lang/String;)Z

    sget-object p0, Lcom/android/camera/module/impl/component/FileUtils;->MUSIC_LOCAL:Ljava/lang/String;

    invoke-static {p0}, Lcom/android/camera/module/impl/component/FileUtils;->makeNoMediaDir(Ljava/lang/String;)Z

    sget-object p0, Lcom/android/camera/module/impl/component/FileUtils;->MUSIC_ONLINE:Ljava/lang/String;
...
.method public pauseRecording()V
    ...
    invoke-direct {p0}, Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;->abandomAudioFocus()V
...
.method public resumeRecording()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;->requestAudioFocus()V
