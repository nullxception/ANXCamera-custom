...
.method public run(Landroid/support/v4/media/MediaSession2$ControllerInfo;)V
    ...
    iget p0, p0, Landroid/support/v4/media/MediaSession2Stub$4;->val$flags:I

    invoke-virtual {p1, v0, p0}, Landroid/support/v4/media/session/MediaControllerCompat;->setVolumeTo(II)V

    goto :goto_0

    :cond_0
    iget p0, p0, Landroid/support/v4/media/MediaSession2Stub$4;->val$value:I

    invoke-virtual {p1, p0}, Landroid/support/v4/media/VolumeProviderCompat;->onSetVolumeTo(I)V
