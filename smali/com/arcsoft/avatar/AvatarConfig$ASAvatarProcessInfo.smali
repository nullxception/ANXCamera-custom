...
.method public checkFaceBlocking()Z
    ...
    cmpl-float v11, v3, p0

    if-lez v11, :cond_a

    const-string p0, "--- > left is blocking <---"
    ...
    :cond_a
    cmpl-float v11, v8, p0

    if-lez v11, :cond_b

    cmpl-float v11, v10, p0
    ...
    const-string p0, "--- > right is blocking <---"
    ...
    const-string p0, "--- > top is blocking <---"
    ...
    const-string p0, "--- > central is blocking <---"
    ...
    const-string p0, "--- > left & right is blocking <---"
