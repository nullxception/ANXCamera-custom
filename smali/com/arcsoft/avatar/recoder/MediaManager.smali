...
.method public drawSurfaceWithTextureId(I)V
    ...
    const-string v0, "drawSurfaceWithTextureId meet error when get lock : "

    iget-boolean v1, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->f:Z
    ...
    invoke-static {v2, p0}, Lcom/arcsoft/avatar/util/CodecLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v5, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->h:Lcom/arcsoft/avatar/recoder/BaseEncoder;

    invoke-virtual {v5}, Lcom/arcsoft/avatar/recoder/BaseEncoder;->lock()V

    iget-object v5, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->q:Lcom/arcsoft/avatar/recoder/FrameQueue;

    invoke-virtual {v5}, Lcom/arcsoft/avatar/recoder/FrameQueue;->isIsInited()Z
    ...
    invoke-virtual {v5}, Lcom/arcsoft/avatar/recoder/FrameQueue;->getFrameForProducer()Lcom/arcsoft/avatar/recoder/FrameItem;

    move-result-object v1

    if-eqz v1, :cond_2

    iget-boolean v5, v1, Lcom/arcsoft/avatar/recoder/FrameItem;->mIsInited:Z
    ...
    :cond_2
    :goto_0
    const-string v5, "drawSurfaceWithTextureId()-> get a null frame item."

    invoke-static {v2, v5}, Lcom/arcsoft/avatar/util/CodecLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    :goto_1
    iget-object v6, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->h:Lcom/arcsoft/avatar/recoder/BaseEncoder;

    invoke-virtual {v6}, Lcom/arcsoft/avatar/recoder/BaseEncoder;->unLock()V
    ...
    invoke-virtual {v5}, Lcom/arcsoft/avatar/recoder/BaseEncoder;->unLock()V
    ...
    :cond_4
    iget-object v5, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->u:[I
    ...
    iput-object v5, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->u:[I

    const/16 v5, 0xba2

    iget-object v6, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->u:[I

    invoke-static {v5, v6, v4}, Landroid/opengl/GLES30;->glGetIntegerv(I[II)V

    :cond_5
    iget-object v5, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->q:Lcom/arcsoft/avatar/recoder/FrameQueue;

    invoke-virtual {v5, v1}, Lcom/arcsoft/avatar/recoder/FrameQueue;->deleteSync(Lcom/arcsoft/avatar/recoder/FrameItem;)V

    iget-object v5, v1, Lcom/arcsoft/avatar/recoder/FrameItem;->mFramebuffer:Lcom/arcsoft/avatar/gl/GLFramebuffer;

    invoke-virtual {v5, v4, v4}, Lcom/arcsoft/avatar/gl/GLFramebuffer;->bind(ZZ)V

    iget v5, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->b:I

    iget v6, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->c:I

    invoke-static {v4, v4, v5, v6}, Landroid/opengl/GLES20;->glViewport(IIII)V

    iget-object v5, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->l:Lcom/arcsoft/avatar/gl/GLRender;

    invoke-virtual {v5, p1}, Lcom/arcsoft/avatar/gl/GLRender;->renderWithTextureId(I)V

    const p1, 0x9117

    invoke-static {p1, v4}, Landroid/opengl/GLES30;->glFenceSync(II)J

    move-result-wide v5

    iput-wide v5, v1, Lcom/arcsoft/avatar/recoder/FrameItem;->a:J

    iget-object p1, v1, Lcom/arcsoft/avatar/recoder/FrameItem;->mFramebuffer:Lcom/arcsoft/avatar/gl/GLFramebuffer;

    invoke-virtual {p1, v4, v4}, Lcom/arcsoft/avatar/gl/GLFramebuffer;->unBind(ZZ)V

    iput-boolean v4, v1, Lcom/arcsoft/avatar/recoder/FrameItem;->mIsEmpty:Z
    ...
    invoke-static {v4, v3, v5, p1}, Landroid/opengl/GLES20;->glViewport(IIII)V

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "drawSurfaceWithTextureId()-> A glError = "
    ...
    iget-object v1, v1, Lcom/arcsoft/avatar/recoder/FrameItem;->mFramebuffer:Lcom/arcsoft/avatar/gl/GLFramebuffer;
    ...
    invoke-static {v2, p1}, Lcom/arcsoft/avatar/util/CodecLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_4
    const-string p0, "drawSurfaceWithTextureId()->C"

    invoke-static {v2, p0}, Lcom/arcsoft/avatar/util/CodecLog;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public initVideoEncoderWithSharedContext(Landroid/opengl/EGLContext;IZLjava/lang/String;)V
    ...
    const-string p2, "MediaManager initVideoEncoderWithSharedContext encoder type = "

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object p2, p0, Lcom/arcsoft/avatar/recoder/MediaManager;->h:Lcom/arcsoft/avatar/recoder/BaseEncoder;

    invoke-virtual {p2}, Lcom/arcsoft/avatar/recoder/BaseEncoder;->getEncoderType()Ljava/lang/String;
    ...
    :cond_0
    const-string p2, "initVideoEncoder()->getInputSurface null."
    ...
    invoke-virtual {p2, p3, v1, v2, p4}, Lcom/arcsoft/avatar/recoder/FrameQueue;->init(IIIZ)V
    ...
    const-string p2, "MediaManager initVideoEncoderWithSharedContext out mInitedEncoderCount = "
