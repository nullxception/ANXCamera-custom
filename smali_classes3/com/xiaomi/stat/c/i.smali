...
.field private static final g:Ljava/lang/String; = "3.0.10"
...
.method private a([Lcom/xiaomi/stat/a/b;Ljava/lang/String;)V
    ...
    invoke-static {v6}, Lcom/xiaomi/stat/d/k;->b(Ljava/lang/String;)V
    ...
    invoke-virtual {v6}, Lcom/xiaomi/stat/b/f;->c()Ljava/lang/String;
    ...
    invoke-static {v6, v0, v3}, Lcom/xiaomi/stat/c/c;->a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/lang/String;
    ...
    invoke-virtual {v6, v4}, Lcom/xiaomi/stat/a/c;->a(Ljava/util/ArrayList;)V
    ...
    const-string v6, "UploaderEngine deleteData= "

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v4, v0}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v6, " retryCount.get()= "
    ...
    iget-boolean v5, v4, Lcom/xiaomi/stat/a/k;->c:Z
...
.method public static a(Ljava/lang/String;)[B
    ...
    const-string v4, "UploaderEngine zipData failed! "
...
.method private a([B)[B
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/stat/b/h;->a([B)[B
...
.method private b(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v1}, Lcom/xiaomi/stat/b/h;->a(Z)V
...
.method private d(Z)Lcom/xiaomi/stat/a/b;
    ...
    const-string v2, "UploaderEngine createMainAppFilter: "
...
.method private h()Z
    ...
    const-string v0, "UploaderEngine acquire lock for uploader failed with "
    ...
    :try_start_1
    iget-object v3, p0, Lcom/xiaomi/stat/c/i;->p:Ljava/nio/channels/FileChannel;
    ...
    iget-object v3, p0, Lcom/xiaomi/stat/c/i;->o:Ljava/nio/channels/FileLock;

    if-eqz v3, :cond_2

    const-string v3, "UploaderEngine acquire lock for uploader"

    invoke-static {v3}, Lcom/xiaomi/stat/d/k;->c(Ljava/lang/String;)V
    :try_end_1
    ...
    :cond_2
    :try_start_3
    const-string v3, "UploaderEngine acquire lock for uploader failed"
    ...
    invoke-static {p0}, Lcom/xiaomi/stat/d/k;->c(Ljava/lang/String;)V
...
.method private i()V
    ...
    :cond_1
    const-string p0, "UploaderEngine releaseLock lock for uploader"
    ...
    const-string v1, "UploaderEngine releaseLock lock for uploader failed with "
...
.method public c()V
    ...
    const-string p0, "UploaderEngine postToServer network is not connected "

    invoke-static {p0}, Lcom/xiaomi/stat/d/k;->b(Ljava/lang/String;)V
    ...
    :cond_2
    :goto_0
    const-string p0, "UploaderEngine postToServer statistic disable or network disable access! "
